...
public class Nivel3 extends Nivel{
    ...
    public void generarRoot() {
        ...
        container.getChildren().addAll(vida,puntaje,vehicle.getElemento(),time.getLb(),rectangle1,rectangle2,rectangle3,nivel,crash);
    ...
    /**
     * Metodo para setear lista de nivel3
     */
    private void setearListaNivel3() {

        Parqueo parkZone = new Parqueo("/image/Pzone.png", 640, 420, -45.0, 110, true);
        Obstaculo ambulancia = new Obstaculo("/image/ambulance.png", 330, 200, 0.0, 60, true);
        ...
        transHLevel3.setAutoReverse(false);
