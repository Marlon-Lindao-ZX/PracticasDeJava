...
public class Nivel2 extends Nivel{
    ...
    public void generarRoot() {
        ...
        container.getChildren().addAll(vida,puntaje,vehicle.getElemento(),time.getLb(),rectangle);
    ...
    private void setearListaNivel2() {
        ...
        Parqueo parkZone = new Parqueo("/image/Pzone.png", 500, 480, 0.0, 100, true);
        Obstaculo ambulancia = new Obstaculo("/image/ambulance.png", 465, 350, -125.0, 64, true);
        Obstaculo policia = new Obstaculo("/image/police.png", 385, 440, -125.0, 50, true);
        Obstaculo mujer = new Obstaculo("/image/woman.png", 170, 300, 0.0, 42, true);
        Obstaculo policia2 = new Obstaculo("/image/police.png",256,529,0.0,50,true);
        Obstaculo hombre = new Obstaculo("/image/man.png", 275, 300, 180.0, 35, true);
        ...
        Obstaculo hombre3 = new Obstaculo("/image/man.png", 645, 290, 180.0, 35, true);
        Obstaculo perro = new Obstaculo("/image/perro.png", 210, 140, 0.0, 30, true);
        Obstaculo perro2 = new Obstaculo("/image/perro.png", 93, 459, -45.0, 30, true);
